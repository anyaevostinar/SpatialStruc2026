...
folder = '../../Data/26_7_31_health_grid/'

treatment_folders = ["health-mutualists-grid", "health-mutualists-gridw1", "health-parasites-grid", "health-parasites-gridw1", "health-nosym-diff-grid", "health-nosym-diff-gridw1", "health-nosym-flat-grid", "health-nosym-flat-gridw1"]
...
for t in treatment_folders:
    for r in reps:
        fname = folder + "/"+t+"/" + str(r) + "/Data" + "/TransmissionRates_data.csv"
        uid = t + "_" + str(r)
