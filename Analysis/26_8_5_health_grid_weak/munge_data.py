...
folder = '../../Data/26_8_5_health_grid_weak/'

treatment_folders = ["health-mutualists-grid",
"health-mutualists-gridw1",
"health-nosym-diff-grid",
"health-nosym-diff-gridw1",
"health-nosym-flat-grid",
"health-nosym-flat-gridw1",
"health-parasites-grid",
"health-parasites-gridw1"]
