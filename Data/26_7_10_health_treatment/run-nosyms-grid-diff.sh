...
#SBATCH --job-name=hnsgd
#SBATCH -o hnsgd%A_%a.out
...
cd /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_10_health_treatment
...
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_10_health_treatment/SymSettings.cfg .
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_10_health_treatment/diff-reward-env.json .
cp /Accounts/roseg/symbulation/SpatialStruc2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 0 -GRID 1 -HOST_REPRO_RES 256 -SYM_HORIZ_TRANS_RES 128 \
