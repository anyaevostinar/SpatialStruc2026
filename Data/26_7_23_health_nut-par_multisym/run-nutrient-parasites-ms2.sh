...
args=" -START_MOI 1 -SYM_LIMIT 2 -ENABLE_NUTRIENT 1 -NUTRIENT_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
...
## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-nutrient-parasites-ms2.sh