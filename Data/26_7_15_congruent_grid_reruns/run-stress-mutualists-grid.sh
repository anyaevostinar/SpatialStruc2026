...
mkdir -p stress-mutualists-grid
cd stress-mutualists-grid
...
args=" -START_MOI 1 -GRID 1 -ENABLE_STRESS 1"
./symbulation_sgp $args -SEED ${SLURM_ARRAY_TASK_ID} > run.log

## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-stress-mutualists-grid.sh