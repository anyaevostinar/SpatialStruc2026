...
args="-START_MOI 1 -GRID 0 -ENABLE_HEALTH 1 -HEALTH_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
...
## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-health-parasites-mixed.sh