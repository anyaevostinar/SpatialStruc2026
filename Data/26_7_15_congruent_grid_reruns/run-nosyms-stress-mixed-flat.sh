...
#SBATCH --job-name=nssmf
#SBATCH -o nssmf%A_%a.out
...
mkdir -p nosyms-stress-mixed-flat
cd nosyms-stress-mixed-flat
...
args=" -START_MOI 0 -ENABLE_STRESS 1 -STRESS_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
...
## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-nosyms-stress-mixed-flat.sh