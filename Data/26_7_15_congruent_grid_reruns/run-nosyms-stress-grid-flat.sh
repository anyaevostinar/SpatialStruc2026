...
#SBATCH --job-name=nssgf
#SBATCH -o nssgf%A_%a.out
...
mkdir -p nosyms-stress-grid-flat
cd nosyms-stress-grid-flat
...
args=" -START_MOI 0 -SPATIAL_STRUCT_MODE grid -ENABLE_STRESS 1 -STRESS_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
...
## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-nosyms-stress-grid-flat.sh