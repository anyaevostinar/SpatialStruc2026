...
#SBATCH --job-name=hmms2
#SBATCH -o hmms2%A_%a.out
...
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_8_5_health_nutrient_multisym_weak/mut_SymSettings.cfg ./SymSettings.cfg
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_8_5_health_nutrient_multisym_weak/diff-reward-env.json .
