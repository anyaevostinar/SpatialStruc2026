...
#SBATCH --job-name=npms5
#SBATCH -o npms5%A_%a.out
...
cd /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_8_5_health_nutrient_multisym_weak
...
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_8_5_health_nutrient_multisym_weak/par_SymSettings.cfg ./SymSettings.cfg
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_8_5_health_nutrient_multisym_weak/flat-reward-2-env.json .
cp /Accounts/roseg/symbulation/SpatialStruc2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args="-ENABLE_NUTRIENT 1 -SYM_LIMIT 5 -HOST_REPRO_RES 3.5 -SYM_HORIZ_TRANS_RES 1"
