...
cd /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_6_stress_treatment_fixed_config
...
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_6_stress_treatment_fixed_config/SymSettings.cfg .
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_6_stress_treatment_fixed_config/flat-reward-5-env.json .
...
## Run with sbatch -p facultynode --nodelist=edmonstone2024,margulis2024,carver,lederberg run-parasites-grid.sh