...
#SBATCH --job-name=snsgd
#SBATCH -o snsgd%A_%a.out
...
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_6_stress_treatment_fixed_config/diff-reward-env.json .
