...
cd /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_multisym_weaker
...
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_multisym_weaker/SymSettings.cfg .
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_multisym_weaker/flat-reward-2-env.json .
cp /Accounts/roseg/symbulation/SpatialStruc2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args="-START_MOI 1 -SYM_LIMIT 5 -ENABLE_HEALTH 1 -HEALTH_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
