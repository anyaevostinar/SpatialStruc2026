...
#SBATCH --job-name=hpg-w1
#SBATCH -o hpg-w1%A_%a.out
...
cd /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_grid_weaker
mkdir -p health-parasites-grid-w1
cd health-parasites-grid-w1

mkdir ${SLURM_ARRAY_TASK_ID}
cd ${SLURM_ARRAY_TASK_ID}

cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_grid_weaker/SymSettings.cfg .
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_grid_weaker/flat-reward-2-env.json .
cp /Accounts/roseg/symbulation/SpatialStruc2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args="-START_MOI 1 -SPATIAL_STRUCT_MODE grid -ENABLE_HEALTH 1 -HEALTH_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
  -HOST_REPRO_RES 2 -SYM_HORIZ_TRANS_RES 2 \
  -HOST_MIN_CYCLES_BEFORE_REPRO 100 -SYM_MIN_CYCLES_BEFORE_REPRO 10 
  -WORLD_WIDTH 1 -WORLD_HEIGHT 10000 \
