...
mkdir -p health-parasites-mixed
cd health-parasites-mixed
...
args="-START_MOI 1 -ENABLE_HEALTH 1 -HEALTH_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json \
