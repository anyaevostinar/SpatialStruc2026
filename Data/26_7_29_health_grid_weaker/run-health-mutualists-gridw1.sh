...
#SBATCH --job-name=hmg-w1
#SBATCH -o hmg-w1%A_%a.out
...
mkdir -p health-mutualists-grid-w1
cd health-mutualists-grid-w1

mkdir ${SLURM_ARRAY_TASK_ID}
cd ${SLURM_ARRAY_TASK_ID}

cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_grid_weaker/SymSettings.cfg .
cp /Accounts/roseg/symbulation/SpatialStruc2026/Data/26_7_29_health_grid_weaker/diff-reward-env.json .
cp /Accounts/roseg/symbulation/SpatialStruc2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1 SPATIAL_STRUCT_MODE grid -ENABLE_HEALTH 1 -HOST_ONLY_FIRST_TASK_CREDIT 1 \
